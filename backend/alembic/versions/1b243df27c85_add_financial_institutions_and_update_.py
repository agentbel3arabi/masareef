...
down_revision: Union[str, Sequence[str], None] = 'phase3_006'
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('bank', 'bnpl', 'digital_wallet_provider', name='institutiontype'), nullable=False),
    ...
    op.add_column('categories', sa.Column('is_system', sa.Boolean(), server_default='false', nullable=False))
...
def downgrade() -> None:
    ...
    op.add_column('accounts', sa.Column('institution', sa.TEXT(), autoincrement=False, nullable=True))
